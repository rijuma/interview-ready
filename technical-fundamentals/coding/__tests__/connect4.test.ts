...
import { Connect4, PLAYER_ONE, PLAYER_TWO } from '../connect4'

// Note from solver: I've updated the tests so the coordinates start at index 1.
// It had a mixture before my changes (cols started at 0 but rows started at 1).
