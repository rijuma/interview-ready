import loopDetection from '../../19_loopDetection'
...
describe('loopDetection', () => {
          ...
          next: {
            ...
            next: {
              ...
              next: {
                ...
                next: {
                  value: 7,
                  next: { value: 8, next: { value: 9, next: loopNode } },
                },
              },
            },
          },
  ...
  test('returns the node at the beginning of the loop (longer loop)', () => {
    ...
    const loopNode: Node<number> = {
      value: 11,
      next: { value: 12, next: { value: 13 } },
    }
            ...
            next: {
              ...
              next: {
                ...
                next: {
                  ...
                  next: {
                    value: 8,
                    next: { value: 9, next: { value: 10, next: loopNode } },
                  },
                },
              },
            },
